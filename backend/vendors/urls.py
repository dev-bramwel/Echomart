...
urlpatterns = [
    ...
    path(
        "bank-details/",
        VendorBankDetailsListAPIView.as_view(),
        name="vendor-bank-details-list",
    ),
    path(
        "bank-details/<int:pk>/",
        VendorBankDetailsAPIView.as_view(),
        name="vendor-bank-details-detail",
    ),
    path(
        "bank-details/<int:pk>/set-default/",
        set_default_bank_account,
        name="set-default-bank",
    ),
]
